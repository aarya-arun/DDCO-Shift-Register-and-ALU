...
module mux8proj (input wire i0,i1,i2,i3,i4,i5,i6,i7, input wire j2, j1, j0, output wire o);
 wire  t0, t1;
  mux4proj mux4_0 (i0,i1,i2,i3, j2, j1, t0);
  mux4proj mux4_1 (i4,i5,i6,i7, j2, j1, t1);
endmodule

module mux4proj (input wire i0,i1,i2,i3, input wire j1, j0, output wire o);
  wire  t0, t1;
...
module mux8 (input wire i0,i1,i2,i3,i4,i5,i6,i7, input wire j2, j1, j0, output wire o);

  wire  t0, t1;

  mux4 mux4_0 (i0,i1,i2,i3, j2, j1, t0);

  mux4 mux4_1 (i4,i5,i6,i7, j2, j1, t1);
*/
